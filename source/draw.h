...
void draw_circle(int x, int y, int radius, char r, char g, char b, int screen);
void draw_fillcircle(int x, int y, int radius, char r , char g, char b, int screen);
void draw_circle_circum(int xc, int yc, int x, int y, char r, char g, char b, int screen);
#endif
